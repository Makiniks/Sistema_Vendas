...
<legend class="legend">Sobre Venda</legend>

<a href="form_cad_venda.php"><button class="botao">Cadastrar</button></a>
<a href="form_alt_venda.php"><button class="botao">Alterar dados</button></a>
<a href="form_con_venda.php"><button class="botao">Consultar</button></a>
<a href="form_exc_venda.php"><button class="botao">Excluir</button></a>
