...
<legend class="legend">Sobre Produto</legend>

<a href="form_cad_prod.php"><button class="botao">Cadastrar</button></a>
<a href="form_alt_prod.php"><button class="botao">Alterar dados</button></a>
<a href="form_con_prod.php"><button class="botao">Consultar</button></a>
<a href="form_exc_prod.php"><button class="botao">Excluir</button></a>
