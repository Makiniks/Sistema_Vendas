...
<legend class="legend">Sobre Estoque</legend>

<a href="form_cad_estoque.php"><button class="botao">Cadastrar</button></a>
<a href="form_alt_estoque.php"><button class="botao">Alterar dados</button></a>
<a href="form_con_estoque.php"><button class="botao">Consultar</button></a>
<a href="form_exc_estoque.php"><button class="botao">Excluir</button></a>
