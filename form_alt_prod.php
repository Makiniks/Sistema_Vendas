...
<legend class="legend">Altera Produto</legend>
...
<label>Novo nome:</label><input type="text" name="nome_prod" id="nome_prod" class="input" required><br><br>
<label>Novo preço:</label><input type="number" name="preco_prod" id="preco" class="input" required><br><br>


</div>

<input type="submit" value="Alterar Produto" class="button_cli">
