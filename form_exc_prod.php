...
<legend class="legend">Excluir Produto</legend>

<form action="excluir_produto.php" method="POST" name="form_cad_cli">

<div class="form">

<label>Digite o RM do produto:</label><input type="number" name="rm_prod" id="rm_prod" class="input" required ><br><br>


</div>

<input type="submit" value="Excluir Produto" class="button_cli">
